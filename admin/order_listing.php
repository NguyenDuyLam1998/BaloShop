...
if (!empty($_SESSION['current_user'])) {
    ...
    if(!empty($where)){
        ...
        $orders = mysqli_query($con, "SELECT * FROM `orders` ORDER BY `id` DESC LIMIT " . 8 . " OFFSET " . $offset);
    }
    mysqli_close($con);
    ?>
    <div class="main-content">
        ...
        <div class="listing-items">
            <div class="buttons">
                ...
                <a calss = "page-item" href="xuat_file_excel.php">Xuất File Excel</a>
            </div>
            ...
            <ul>
                <li class="listing-item-heading">
                    ...
                    <div class="listing-prop listing-button">Đơn hàng</div>
