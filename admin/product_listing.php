    ...
    <div class="main-content">
        ...
        <div class="listing-items">
            <div class="buttons">
                ...
                <a href="xuatexcel.php">Xuất <?=$config_title?></a>
                <a calss = "page-item" href="xuat_file_excel.php">Xuất khách hàng</a>
            </div>
            ...
            <ul>
                <li class="listing-item-heading">
                    ...
                    <div class="listing-prop listing-price">Giá <?=$config_title?></div>
                ...
                while ($row = mysqli_fetch_array($products)) {
                    ...
                    <li>
                        ...
                        <div class="listing-prop listing-price"><?= $row['price'] ?></div>
                        <div class="clear-both"></div>
                    </li>
                <?php } ?>
            </ul>
